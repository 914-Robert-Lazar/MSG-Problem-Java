...
public class BankingApplication {
    ...
    public static void main(String[] args) {
        ...
        TransactionModel transaction2 = transactionManagerServiceInstance.transfer(
                checkingAccountB.getId(), checkingAccountA.getId(), new MoneyModel(40, CurrencyType.EUR));
        System.out.println("[Transaction Manager] 4. " + transaction2);

        System.out.println("[Transaction Manager] 5. " + transactionManagerServiceInstance.checkFunds(checkingAccountA.getId()));
        System.out.println("[Transaction Manager] 6. " + transactionManagerServiceInstance.checkFunds(checkingAccountB.getId()));
